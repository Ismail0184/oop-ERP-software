...
<?php if($COUNT_details_data>0){?>
    ...
    <?php } ?>
<?php
$sql_find_do = "SELECT * from ".$sale_do_master." where do_date='".$_SESSION['sales_date']."' and section_id='".$_SESSION['sectionid']."' and company_id='".$_SESSION['companyid']."'";
...
while($data = mysqli_fetch_object($result)){
    ...
    <table align="center" class="table table-striped table-bordered" style="width:98%;font-size:11px; display:">
        ...
        <tr>
            ...
            <td align="center" style="vertical-align: middle"><input type="text" name="dr_amount_1" readonly value="<?=$total_sales_amount;?>" class="form-control col-md-7 col-xs-12" style="width:100%; height:35px; font-size: 11px; text-align:center" ></td>
        ...
        <tr>
            ...
            <td style="text-align: right; vertical-align: middle"><input type="text" name="cr_amount_2" readonly value="<?=$total_sales_amount;?>" class="form-control col-md-7 col-xs-12" style="width:100%; height:35px; font-size: 11px; text-align:center" ></td>
        </tr>
        <tr>
