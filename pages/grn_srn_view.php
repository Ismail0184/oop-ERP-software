...
r.entry_by=u.user_id and r.rcv_Date between "'.$fDate.'" and "'.$tDate.'"
group by r.'.$unique.'
...
<form  name="addem" id="addem" class="form-horizontal form-label-left" method="post" >
        <table align="center" style="width: 50%;">
            <tr><td>
                    <input type="date" style="width:150px; font-size: 11px; height: 25px"  value="<?php if(isset($fDate)) echo $fDate; else echo date('Y-m-01');?>" max="<?=date('Y-m-d');?>" required   name="f_date" >
                                ...
                                <tr>
                                    <td valign="top">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
                                            ...
                                            <tr>
                                                ...
                                                <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                                                        <tr>
                                                            <td height="60" valign="top"><?=$dealer->address;?>&nbsp;</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                                                        <tr>
                                                            <td>By: <?php echo find_a_field('users','fname','user_id='.$entry_by);?>/ At: <?=$entry_at?></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                    ...
                                    <td width="40%"><table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
                                            ...
                                            <tr>
                                                ...
                                                <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                                                        <tr>
                                                            <td><?php $QCBy=find_a_field('purchase_receive','distinct qc_by','pr_no='.$pr_no);?>&nbsp;
                                                                <?=find_a_field('users','fname','user_id='.$QCBy);?>&nbsp;</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
            ...
            <table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5">
                ...
                <? if ($tax >0){?>
                    <tr>
                        ...
                        <td align="right" valign="top">
                            <strong>
                                <?php $with_tax=(($t_amount)*($tax))/(100); echo number_format($with_tax,2)?>
                            </strong>
                        </td>
                    </tr>
                <?php } ?>
                ...
                <? if ($taxait >0){?>
                    <tr>
                        <td colspan="6" align="right" valign="top"><strong>Tax(<?=$tax?>%)</strong></td>
                        <td align="right" valign="top">
                            <strong>
                ...
                <? if ($cash_discount >0){?>
                    <tr>
                        ...
                        <td align="right" valign="top">
                            <strong><?=number_format($cash_discount,2)?></strong>
                        </td>
                    </tr>
                <?php } ?>
                <tr>
                    ...
                    <td align="right" valign="top">
                        <strong><?=number_format(($totalpayable-$cash_discount),2)?></strong>
                    </td>
                </tr>
            </table>
        </td>
                    ...
                    <td colspan="2" align="center">
                        <table style="font-size:11px; margin-top:50px" width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td align="center" style="text-decoration:overline"><strong>Approved By </strong></td></tr>
                        </table>
                    </td>
                </tr>
                <tr>
