...
$title="Primary DO List";
 ...
 <?php require_once 'header_content.php'; ?>
    <script type="text/javascript">
         ...
         {myWindow = window.open("<?=$target_url;?>?<?=$unique_master;?>="+lk, "myWindow", "toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no,directories=0,toolbar=0,scrollbars=1,location=0,statusbar=1,menubar=0,resizable=1,width=950,height=570,left = 250,top = -1");}
     </script>
 ...
 <table align="center" style="width: 50%;">
     <tr><td>
         ...
         <td style="padding:10px"><button type="submit" style="font-size: 11px;" name="viewreport"  class="btn btn-primary">View Invoices</button></td>
     </tr></table>
 </form>
