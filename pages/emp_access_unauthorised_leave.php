...
if (empty($leaveRequest->approved_viewed_at))
{
    ...
    <form  name="addem" id="addem" class="form-horizontal form-label-left" method="post">
        ...
        <table align="center" class="table table-striped table-bordered" style="width:90%;font-size:11px; margin-top: 5px">
            ...
            <tr>
                ...
                <td style="text-align: center; vertical-align:middle"><input type="text" class="form-control col-md-7 col-xs-12" placeholder="Enter a note for the application, if necessary" required name="remarks_while_approved" style="width: 99%; font-size: 11px"></td>
            </tr>
            </tbody>
        </table>
