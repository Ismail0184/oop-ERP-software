...
$reason = @$reason;
$leave_responsibility_name = @$leave_responsibility_name;
$leave_mobile_number = @$leave_mobile_number;
$PBI_IN_CHARGE = @$PBI_IN_CHARGE;
...
$s_date_s="".$year."-01-01";
$s_date_e="".$year."-12-31";
$policy=find_a_field('hrm_leave_type','yearly_leave_days','id='.$GetType .'');
$alrady_taken=find_a_field('hrm_leave_info','SUM(total_days)','half_or_full="Full" and e_date between "'.$s_date_s.'" and "'.$s_date_e.'"
	and s_date between "'.$s_date_s.'" and "'.$s_date_e.'"  and PBI_ID='.$_SESSION['PBI_ID'].' and type='.$GetType .'');
            ...
            <form  name="addem" id="addem" class="form-horizontal form-label-left" method="post">
                ...
                <table style="width:100%; font-size:11px;">
                    ...
                    <tr>
                        ...
                        <th>Reason <span class="required text-danger">*</span></th>
