    ...
    <div class="col-md-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                ...
                <a style="float: right" class="btn btn-sm btn-default"  href="po_from_MAN.php">
                    <i class="fa fa-plus-circle"></i> <span class="language" style="color:#000; font-size: 11px">Po from MAN</span>
                </a>
