    ...
    <form action="<?=$page;?>" name="addem" id="addem" class="form-horizontal form-label-left" method="post">
        ...
        <table align="center" style="width:98%; font-size: 11px" class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <td style="width:10%; vertical-align: middle" align="center">
                    <input type="number" id="unit_price" style="width:99%; height:37px; font-size:11px;text-align:center" min="1" step="any" required="required" value="<?=($item_ids>0)? $item_all_d_price : $edit_value_unit_price?>" name="unit_price"  class="form-control col-md-7 col-xs-12" autocomplete="off" class="unit_price" ></td>
                <td style="width:10%; vertical-align: middle" align="center">
