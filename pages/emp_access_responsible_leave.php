...
<?php if(isset($_GET[$unique])){ ?>
    <form  name="addem" id="addem" class="form-horizontal form-label-left" method="post">
        ...
        <table align="center" class="table table-striped table-bordered" style="width:90%;font-size:11px; margin-top: 5px">
            ...
            <thead>
            <tr>
                <th style="text-align: center; vertical-align:middle">Leave Type</th>
                <th style="text-align: center; vertical-align:middle">Start From</th>
                <th style="text-align: center; vertical-align:middle">End To</th>
                <th style="text-align: center; vertical-align:middle; width: 10%">Total Days</th>
            ...
            <tr>
                ...
                <td style="text-align: center;"><input type="date" id="s_date" onchange="cal()" style="width: 99%; font-size:11px; text-align: center"  required="required" name="s_date" value="<?php if($$unique>0){ echo $leaverequest->s_date; } else { echo ''; } ?>" class="form-control col-md-7 col-xs-12" ></td>
                <td style="text-align: center"><input type="date" id="e_date"  onchange="cal()" style="width: 99%; font-size:11px; text-align: center"  required="required" name="e_date" value="<?php if($$unique>0){ echo $leaverequest->e_date; } else { echo ''; } ?>" class="form-control col-md-7 col-xs-12" ></td>
                <td style="text-align: center"><input type="text" id="applied" style="width: 99%; font-size:11px; text-align: center"  required="required" name="total_days11" value="<?=number_format($leaverequest->total_days);?>" class="form-control col-md-7 col-xs-12" ></td>
