...
<div class="menu_section">
    <ul class="nav side-menu">
        ...
        <li><a href="#"><i class="fa fa-circle-o"></i>Checking <br><?php if($totChecked>0) { ?><?='[<span style="color:red;font-weight:bold; font-size:15px"> '.$totChecked.' </span>]'?> <?php } else {echo'';} ?><span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
        ...
        <li>
            <a href="#"><i class="fa fa-wpforms"></i>Requisition <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
        ...
        <li>
            <a href="#"><i class="fa fa-tasks"></i>Task Management <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
                <li><a href="emp_access_task_management_create.php">Create Task</a></li>
                <li><a href="emp_access_task_management_assign.php">Assign Task</a></li>
                <li><a href="emp_access_task_management_view.php">Tasks Status</a></li>
            </ul>
        </li>
