...
{   $up="UPDATE ".$table." SET verifi_status='UNCHECKED' where ".$unique."='".$pi_tr."'";
    $update_table_master=mysqli_query($conn, $up);
    $up2="UPDATE ".$table_details." SET verifi_status='UNCHECKED',status='UNCHECKED' where ".$unique."='".$pi_tr."'";
...
$GetID = @$_GET['id'];
if (isset($GetID)) {
$variable_item_id=@$edit_value->item_id;
} else {
    $variable_item_id=@$_GET['item_id'];
}


$item_info=find_all_field("item_info", "", "item_id=".$variable_item_id."");
$item_info_unit_name = @$item_info->unit_name;
$item_info_pack_size = @$item_info->pack_size;
...
$Manual_item=find_a_field("production_issue_detail", "SUM(total_unit)", "item_id='".$variable_item_id."' and warehouse_from=".$warehouse_from." and status in ('MANUAL','UNCHECKED')");
                ...
                <table style="width:100%">
                    <tr>
                        <td>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" style="width: 30%">STO NO <span class="required text-danger">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" id="custom_pi_no" style="width:100%" readonly name="custom_pi_no" value="<?=($initiate_production_transfer!='')? $custom_pi_no : automatic_number_generate("STO","production_issue_master","custom_pi_no","create_date='".$idatess."' and   custom_pi_no like '$sekeyword%'","");?>" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td style="width:35%; vertical-align: middle">
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name" style="width: 30%">Transfer From <span class="required text-danger">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" style="width:100%; font-size: 11px" tabindex="-1" required="required"  name="warehouse_from" id="warehouse_from">
                                        <option></option>
                                        <?php if(isset($initiate_production_transfer)>0): ?>
                            ...
                            <td style="width:35%">
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name" style="width: 30%">Transfer To <span class="required text-danger">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name" style="width: 30%">Transporter
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <td>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" style="width: 30%">Track No.</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <td>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name" style="width: 30%">Driver Info <span class="required text-danger">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
...
<?php if($initiate_production_transfer):?>
            <form action="<?=$page;?>" name="addem" id="addem" class="form-horizontal form-label-left" method="post" style="font-size: 11px">
                <input type="hidden" name="<?=$unique;?>" id="<?=$unique;?>" value="<?=$pi_tr;?>" >
                ...
                <table align="center" style="width:98%; font-size: 11px" class="table table-striped table-bordered">
                    ...
                    <td style="vertical-align: middle">
                            <select class="select2_single form-control" style="width: 100%" tabindex="-1" required="required" name="item_id" id="item_id" onchange="javascript:reloaditem(this.form)">
                                <option></option>
                                <? advance_foreign_relation(find_all_item($product_nature="'Salable','Both'"),($variable_item_id>0)? $variable_item_id : $edit_value_item_id);?>
                            </select>
                        </td>
                        <td style="vertical-align: middle;width:10%; text-align:center">
                            <input type="text" id="unit" style="width:100%; height:37px; font-weight:bold; text-align:center"   name="unit" readonly  class="form-control col-md-7 col-xs-12" value="<?=$item_info_unit_name;?>" >
                        </td>
                        <td style="vertical-align: middle;width:10%; text-align:center">
                            <input type="text" id="pack_size" style="width:100%; height:37px; font-weight:bold; text-align:center"   name="pack_size" readonly  class="form-control col-md-7 col-xs-12" value="<?=$item_info_pack_size;?>" >
                        </td>
