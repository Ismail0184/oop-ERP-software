...
$POSTPurposeOfEditDelete=@$_POST['purpose_of_edit_delete'];
...
mysqli_query($conn, "UPDATE journal_deleted SET delete_at='$todaysss' WHERE tr_no='$v_no' AND tr_from='$tr_from'");
    ...
    $txt1 = "<p>Dear Sir,</p>
				...
				<p><strong>Purpose of Deleted :</strong> <strong style='color:red'>".$POSTPurposeOfEditDelete."</strong></p>
