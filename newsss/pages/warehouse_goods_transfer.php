    ...
    <form action="<?=$page;?>" name="addem" id="addem" class="form-horizontal form-label-left" method="post" style="font-size: 11px">
        ...
        <table align="center" style="width:98%; font-size: 11px" class="table table-striped table-bordered" id="customers">
            ...
            <tr>
                ...
                <td style="vertical-align: middle;width:10%; text-align:center">
                    <input type="text" id="total_unit<?=$item_id?>" onkeyup="doAlert<?=$item_id?>(this.form);" name="total_unit<?=$item_id?>" value="<?=$edit_value_total_unit?>" style="width:96%; margin-left:2%; height:25px;font-size: 11px; text-align:center;"   class="form-control col-md-7 col-xs-12" autocomplete="off" tabindex="1" />
                </td>
                ...
                <tr><th colspan="4">Total</th><td></td></tr>
            <?php endwhile; ?>
