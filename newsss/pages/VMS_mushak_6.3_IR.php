  ...
  padding:0px;"></td>
    ...
    <table id="customers" style="border-collapse: collapse; border: 1px solid #CCC; width: 100%">
        ...
        <tr>
            ...
            <th style="border: 1px solid #CCC;width: 10%">মূল্য সংযোজন কর/ সুনির্দিষ্ট কর এর পরিমণ (টাকায়)</th>
            <th style="border: 1px solid #CCC;width: 10%">সকল প্রকার শুল্ক ও করসহ মূল্য</th>
        </tr>
        ...
        $cd=$data->total_unit*$data->VAT*$ab;?>
            ...
            <tr>
                ...
                <td></td>
                <td></td>
                <th style="border: 1px solid #CCC;text-align: center;"><?=$total_unit?></th>
                <td></td>
        ...
        $cd=$data->total_unit*$data->VAT*$ab;?>
            ...
            <tr>
                ...
                <td style="border: 1px solid #CCC;text-align: center">
                    ...
                    <input type="number" value="<?=$data->total_unit?>" onkeyup="doAlert<?=$id?>(this.form);" style="font-size:11px; text-align:center;" name="total_unit<?=$id?>" id="total_unit<?=$id?>" class="total_unit<?=$id?>">
                </td>
                <td style="border: 1px solid #CCC;text-align: right;">
                    <input type="number" tabindex="-1" readonly value="<?=$data->VAT?>" style="font-size:11px; text-align:right;border: 1px solid #999999;background-color: #F0F0F0;color: #666666;" name="unit_price<?=$id?>" id="unit_price<?=$id?>" class="unit_price<?=$id?>">
                </td>
                <td style="border: 1px solid #CCC;text-align: right;">
                    <input type="number" tabindex="-1" readonly value="<?=$total_unit_amount=$data->total_unit*$data->VAT?>" style="font-size:11px; text-align:right;border: 1px solid #999999;background-color: #F0F0F0;color: #666666;" name="total_price<?=$id?>" id="total_price<?=$id?>" class="total_price<?=$id?>">
                </td>

                <td style="border: 1px solid #CCC;text-align: right;">
                    <input type="number" tabindex="-1" readonly value="<?=($data->SD_percentage>0)? $data->SD_percentage : '0';?>" style="font-size:11px; text-align:right;border: 1px solid #999999;background-color: #F0F0F0;color: #666666;" name="rate_of_SD<?=$id?>" id="rate_of_SD<?=$id?>" class="rate_of_SD<?=$id?>">
                </td>

                <td style="border: 1px solid #CCC;text-align: right;">
                    <input type="number" tabindex="-1" readonly value="<?=$amount_of_SD=(($total_unit_amount*$data->SD_percentage)/100)?>" style="font-size:11px; text-align:right;border: 1px solid #999999;background-color: #F0F0F0;color: #666666;" name="amount_of_SD<?=$id?>" id="amount_of_SD<?=$id?>" class="amount_of_SD<?=$id?>">
                </td>

                <td style="border: 1px solid #CCC;text-align: right;">
                    <input type="number" tabindex="-1" readonly value="<?=$data->VAT_percentage?>" style="font-size:11px; text-align:right;border: 1px solid #999999;background-color: #F0F0F0;color: #666666;" name="rate_of_VAT<?=$id?>" id="rate_of_VAT<?=$id?>" class="rate_of_VAT<?=$id?>">
                </td>

                <td style="border: 1px solid #CCC;text-align: right;">
                    <input type="number" tabindex="-1" readonly value="<?=$total_VAT=((($total_unit_amount+$amount_of_SD)*$data->VAT_percentage)/100);?>" style="font-size:11px; text-align:right;border: 1px solid #999999;background-color: #F0F0F0;color: #666666;" name="amount_of_VAT<?=$id?>" id="amount_of_VAT<?=$id?>" class="amount_of_VAT<?=$id?>">
                </td>

                <td style="border: 1px solid #CCC;text-align: right;">
                    <input type="number" tabindex="-1" readonly value="<?=$actual_VAT=$total_unit_amount+$amount_of_SD+$total_VAT;?>" style="font-size:11px; text-align:right;border: 1px solid #999999;background-color: #F0F0F0;color: #666666;" name="total_including_all<?=$id?>" id="total_including_all<?=$id?>" class="total_including_all<?=$id?>">
                </td>
            </tr>
