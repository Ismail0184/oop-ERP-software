...
if(isset($vendor_id))				{$vendor_id_conn=' and v.vendor_id='.$vendor_id;} else {$vendor_id_conn='';}
?>
...
<?php elseif ($_POST['report_id']=='3001001'):
    $sql="Select pm.po_no,pm.po_no,pm.po_date,concat(pm.vendor_id,' : ',v.vendor_name) as vendor,i.item_id as 'Mat. Code',i.item_name as 'Mat. Description',i.unit_name as 'UoM',pi.qty,(pi.amount/pi.qty) as rate,pi.amount as Value,pm.tax as VAT  from
    purchase_master pm,
    purchase_invoice pi,
    vendor v,
    item_info i
