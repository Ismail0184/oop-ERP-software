...
if(prevent_multi_submit()){
    ...
    { $file = fopen($filename, "r");
        ...
        { if(!empty($eData[4]) && $eData[6]>0) {
                $entry_at = date('Y-m-d H:i:s');
                $sql = "INSERT INTO `purchase_invoice_from_prism_software`
   (`po_no`,`po_id`,`po_date`,`vendor_id`,`item_id`,`item_name`,`warehouse_id`,`rate`,`qty`,`amount`,`entry_by`,`entry_at`,`status`,`section_id`,`company_id`)
	         VALUES ('".$_POST['po_no']."','".$_POST['po_id']."','".$_POST['po_date']."','".$_POST['vendor_id']."','','$eData[4]','".$_POST['warehouse_id']."','','$eData[6]','','".$_SESSION['userid']."','".$entry_at."','MANUAL','".$sectionid."','".$_SESSION['companyid']."')";
