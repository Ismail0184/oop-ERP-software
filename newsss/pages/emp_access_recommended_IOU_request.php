...
$page="emp_access_recommended_IOU_request.php";
$crud      =new crud($table);
...
if(isset($_POST['viewReport'])){
    ...
    $res='SELECT r.id,
     ...
     p2.PBI_DEPARTMENT=d.DEPT_ID) as Application_By,r.purpose,concat(r.date,", ",r.time) as when_need,FORMAT(r.amount,2) as amount,r.status from '.$table.' r where r.user_id='.$_SESSION['PBI_ID'];
